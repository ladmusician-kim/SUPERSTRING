...
function js_height_init(){
    (function($){
        ...
        $(".js-height-parent").each(function () {
            /* superstring Ȩ main height */
            var id = $(this).attr('id');
            if (id == "home") {
                if (isMobile) {
                    $(this).height(400);
                    $($('.superstring-main-fullwidth')[0]).css("padding-top", 95);
                } else {
                    $(this).height(620);
                }
            } else if (id == "ce") {
                if (isMobile) {
                    $(this).height(400);
                    $($('.superstring-main-fullwidth')[0]).css("padding-top", 59);
                } else {
                    $(this).height(440);
                }
            } else if (id == "h") {
                if (isMobile) {
                    $(this).height(310);
                    $($('.superstring-main-fullwidth')[0]).css("padding-top", 61);
                } else {
                    $(this).height(390);
                }
            } else if (id == "hotdiamond") {
                if (isMobile) {
                    $(this).height(310);
                    $($('.superstring-main-fullwidth')[0]).css("padding-top", 90);
                } else {
